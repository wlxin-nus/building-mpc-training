...
class HierarchicalMpcController:
    ...
    def decide(
        ...
        *,
        ...
        if forecast_window.zones != zones or forecast_window.horizon_steps != horizon:
            raise ValueError("MPC forecast window does not match the frozen model layout")
        disturbances = forecast_window.optimizer_disturbances
        prices = forecast_window.optimizer_prices
        occupancy = forecast_window.optimizer_occupancy
        action_times = forecast_window.optimizer_action_times
        daily_outdoor_means_c = forecast_window.daily_outdoor_means_c
        terminal_counts = forecast_window.terminal_occupancy
